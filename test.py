    ...
    try:
        ...
        while answer == "Y":
            ...
            if startingpoint=="E":
                ...
                print()
                print("Campground Name\t\t\tRank Score")
                for index in range(len(EastGateResult)):
                    matchName = EastGateResult[index][0]
                    matchScore = EastGateResult[index][1]
                ...
                for index in range(len(WestGateResult)):
                    matchName = WestGateResult[index][0]
                    matchScore = WestGateResult[index][1]
                    print(matchName, '\t\t', matchScore)
            print()
            print("***************************************************************")
            print()
